...
const TransactionHistory: React.FC = () => {
  ...
  return (
    ...
    <div className="flex">
      <section className="flex-1 overflow-auto ml py-12 px-4 sm:px-10 bg-lime-100">
              <h1 className="text-3xl font-bold text-gray-800 mb-8 text-start">Transaction History</h1>
                          ...
                          {transactions.map((transaction, index) => (
                              ...
                              >
                                  ...
                                  <td className="py-3 px-6">
                                      <span
                                          className={`px-2 py-1 rounded text-sm font-medium ${transaction.status === 'Completed'
